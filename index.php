...
<!--Left panel-->
<? if(file_exists("left.php")) { include("left.php"); } ?>
		</td>
		<td valign=top align=center bgcolor="#ffffff">
<? if(file_exists("topbanner.php")) { include("topbanner.php"); } ?>
<?
echo $pagecontent;
?>
<? if(file_exists("bottombanner.php")) { include("bottombanner.php"); } ?>
		</td>
		<td valign=top align=center  width="160">
<? if(file_exists("right.php")) { include("right.php"); } ?>
		</td>
	</tr>
</table>
